...
using HateoasExample.Models;
using Microsoft.AspNetCore.Mvc;


namespace HateoasExample.Controllers
{
    ...
    public class PeopleController : Controller
    {
        ...
        {
            new PersonDto {Id = 1, Name = "Fanie", Email = "fanie@example.com"},
            new PersonDto {Id = 2, Name = "John", Email = "john@example.com"},
