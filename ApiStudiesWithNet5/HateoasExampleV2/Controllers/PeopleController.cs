...
using HateoasExampleV2.Models;
using Microsoft.AspNetCore.Mvc;

namespace HateoasExampleV2.Controllers
{
    ...
    public class PeopleController : Controller
    {
        ...
        {
            new PersonDto { Id = 1, Name = "Carlos", Email = "carlos@example.com"},
            new PersonDto { Id = 2, Name = "Marcos", Email = "marcos@example.com"},
            new PersonDto { Id = 3, Name = "Paula", Email = "paula@example.com"},
        };
