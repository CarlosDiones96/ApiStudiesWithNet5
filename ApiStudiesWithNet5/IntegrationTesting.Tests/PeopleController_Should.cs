...
namespace IntegrationTesting.Tests
{
    public class PeopleController_Should
    {
        ...
        public async Task Return_Cached_Person_As_Xml_Given_Id()
        {
            ...
            client.DefaultRequestHeaders.Accept.Add(new MediaTypeWithQualityHeaderValue("application/xmal"));
            ...
            Assert.Equal("application/xmal", response.Content.Headers.ContentType.MediaType);
